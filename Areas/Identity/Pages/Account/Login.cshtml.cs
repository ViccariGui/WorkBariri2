...
namespace WorkBariri2.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [EmailAddress(ErrorMessage = "O formato do E-mail está incorreto.")]
            [Display(Name = "E-mail")]
            ...
            [DataType(DataType.Password, ErrorMessage = "O formato do E-mail está incorreto.")]
            [Display(Name = "Senha")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var usuario = _context.Usuario.FirstOrDefault(u => u.AppUserId == Guid.Parse(userId));
